...
<nav class="navbar">
	<div class="nav-container">
		...
		<ul class="nav-menu">
			...
			<li><a href="/loadout" class="nav-link">로드아웃</a></li>
			<li><a href="/equipments" class="nav-link">장비정보</a></li>
			<li><a href="/enemies" class="nav-link">적정보</a></li>
		</ul>
	</div>
</nav>
